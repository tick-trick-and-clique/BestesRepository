...
os.system("python3 Main.py -i klein.graph mittel.graph -mp -elc -go mp_elc_klein_mittel.graph")
os.system("python3 Main.py -i klein.graph mittel.graph -mp -vlc -go mp_vlc_klein_mittel.graph")
os.system("python3 Main.py -i klein.graph mittel.graph -mp -vlc -elc -go mp_both_klein_mittel.graph")
...
print("9______________python3 Main.py -i klein.graph mittel.graph groß.graph -ga bk -vlc -sgo_______________")
os.system("python3 Main.py -i klein.graph mittel.graph groß.graph -ga bk -vlc -sgo")
# -i <GRAPH1> <GRAPH2> <GRAPH3> -ga bk -sgo -elc
print("10______________python3 Main.py -i klein.graph mittel.graph groß.graph -ga bk -elc -sgo_______________")
os.system("python3 Main.py -i klein.graph mittel.graph groß.graph -ga bk -elc -sgo")
# -i <GRAPH1> <GRAPH2> <GRAPH3> -ga bk -sgo -vlc -elc
print("11______________python3 Main.py -i klein.graph mittel.graph groß.graph -ga bk -vlc -elc -sgo_______________")
...
print("12______________python3 Main.py -i klein.graph mittel.graph groß.graph -ga bk -vlc label_comp_functions.py vertices_are_compatible -sgo_______________")
...
print("13______________python3 Main.py -i klein.graph mittel.graph groß.graph -ga bk -elc label_comp_functions.py edges_are_compatible -sgo_______________")
...
print("14______________python3 Main.py -i klein.graph mittel.graph groß.graph -ga bk -vlc label_comp_functions.py vertices_are_compatible -elc label_comp_functions.py edges_are_compatible -sgo_______________")
...
print("15______________python3 Main.py -i klein.graph mittel.graph groß.graph -ga bk -sgo -no applied_gT.newick_______________")
os.system("python3 Main.py -i klein.graph mittel.graph groß.graph -ga bk -sgo -no applied_gT.newick")
# -i <GRAPH1> <GRAPH2> <GRAPH3> -ga bk -sgo -gt <FILE>
print("16______________python3 Main.py -i klein.graph mittel.graph groß.graph -ga bk -gt given_gT.newick -sgo_______________")
os.system("python3 Main.py -i klein.graph mittel.graph groß.graph -ga bk -gt given_gT.newick -sgo")
# -i <GRAPH1> <GRAPH2> <GRAPH3> -ga bk -sgo -gt pairwise_align
print("17______________python3 Main.py -i klein.graph mittel.graph groß.graph -ga bk -gt pairwise_align -sgo_______________")
...
print("18______________python3 Main.py -i klein.graph mittel.graph groß.graph -ga bk -gt density -sgo_______________")
...
print("19______________python3 Main.py -i klein.graph mittel.graph groß.graph -ga bk -gt custom difference_vertices_for_guide_tree.py vertices_number -sgo_______________")
