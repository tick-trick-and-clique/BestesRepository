...
parser.add_argument("-go", "--graph_output", metavar="Graph Output file (path)", nargs='?', const=1,
                    help="Saves graph as .graph file. If a path (in quotation marks!) is provided, graph will be saved "
                         ...
                         "attribute.")
parser.add_argument("-sgo", "--subgraphs_output", metavar="Subgraphs Output file (path)", nargs='*',
...
parser.add_argument("-no", "--newick_output", metavar="Newick string output file (path)", nargs='?', const=1,
...
parser.add_argument("-bk", "--bron_kerbosch", nargs='?', const=-1, help="Invokes maximal clique "
                                                                                             "finding on input graph.")
