...
parser.add_argument("-o", "--output_file", nargs='?', const=0, help="Saves graph as .graph file. If a path is provided,"
                                                                    "graph will be saved there. If a .graph file name "
                                                                    "is provided, it will be saved with that name in "
                                                                    "the current working directory. Else it will be "
                                                                    "saved in the current working directory using its "
                                                                    "name attribute ")
