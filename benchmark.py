...
def benchmark_bk(benchmark_filename, input_graph_name, number_of_graphs,
                 commandstring_before_input, commandstring_after_input):
    i = 1
    while i <= number_of_graphs - 1:
        input_string_1 = input_graph_name + "_" + str(i) + ".graph"
        i += 1
        input_string_2 = input_graph_name + "_" + str(i) + ".graph"
        i += 1
...
number_of_middle_graphs = 60    # TODO: Set number
input_graph_name_middle = "rg_middle_8_0.4" # TODO: Set name
create_random_graphs(8, 0.4, False, number_of_middle_graphs, input_graph_name_middle)
## Big random graphs
number_of_big_graphs = 30   # TODO: Set number
input_graph_name_big = "rg_big_8_0.4" # TODO: Set name
create_random_graphs(12, 0.4, False, number_of_middle_graphs, input_graph_name_big)
...
benchmark_ga(benchmark_filename, input_graph_name_big, number_of_middle_graphs,
